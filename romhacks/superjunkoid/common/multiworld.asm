...
table ../../common/box_yellow.tbl,rtl
item_names:
    dw "___         A HEART          ___"
    dw "___        MAGIC BOLT        ___"
    dw "___         BASEBALL         ___"
    dw "___        SPARKSUIT         ___"
    dw "___        RAT BURST         ___"
    dw "___       GEM OF DEATH       ___"
    dw "___        GEM OF ICE        ___"
    dw "___         FEATHER          ___"
    dw "___        RAT DASHER        ___"
    dw "___       GEM OF BLOOD       ___"
    dw "___       WAVE BANGLE        ___"
    dw "___      PURPLE LOCKET       ___"
    dw "___       SANGUINE FIN       ___"
    dw "___        MAGIC SOAP        ___"
    dw "___       GEM OF STORMS      ___"
    dw "___      DREAMERS CROWN      ___"
    dw "___       MAGIC BROOM        ___"
    dw "___        WALLKICKS         ___"
    dw "___        RAT CLOAK         ___"
    dw "___       A LUCKY FROG       ___"
    dw "___      BIG LEAGUE GLOVE    ___"
